...
SPICEOS_VERSION := NEW_ERA

LINEAGE_VERSION := SpiceOS-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(SPICEOS_VERSION)-$(shell date +%Y%m%d)-$(LINEAGE_BUILD)-$(SPICEOS_BUILDTYPE)
LINEAGE_DISPLAY_VERSION := SpiceOS-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(SPICE_OS_VERSION)-$(LINEAGE_BUILD)-$(SPICEOS_BUILDTYPE)
